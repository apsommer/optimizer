...
opt = LiveParams(
    ...
    takeProfitPercent = np.around(np.linspace(0.5, 2, 16), 2),
    stopLossPercent = [0], # np.around(np.linspace(.25, .65, 9), 2),
    fastAngleEntryFactor = [40], # np.linspace(15, 35, 3, dtype = int),
    fastAngleExitFactor = [3505], # np.linspace(1000, 3000, 401, dtype = int),
    slowMinutes = [1805], # np.linspace(1755, 3055, 7, dtype = int),
    slowAngleFactor = [5, 10], # np.linspace(15, 50, 8, dtype = int),
    coolOffMinutes = [45], # np.linspace(0, 25, 26, dtype = int),
    trendStartHour = [25], # np.linspace(0, 12, 13, dtype = int),
    trendEndHour = [90], # np.linspace(12, 212, 201, dtype = int),
)
