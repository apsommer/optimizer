...
opt = LiveParams(
    ...
    fastCrossoverPercent = [80], # [0, 75, 85, 95], # np.linspace(75, 95, 5),
    takeProfitPercent = np.around(np.linspace(0.35, 0.75, 9), 2),
    stopLossPercent = [0], # np.around(np.linspace(.25, .65, 9), 29
    fastAngleEntryFactor = [15, 20, 25, 30, 35], # np.linspace(15, 35, 5, dtype = int),
