...
opt = LiveParams(
    ...
    fastAngleEntryFactor = [15, 20, 25, 35, 40], # np.linspace(15, 35, 5, dtype = int),
    fastAngleExitFactor = [2050], # np.linspace(1000, 3000, 401, dtype = int),
    slowMinutes = [2105], # np.linspace(1755, 3055, 7, dtype = int),
    slowAngleFactor = [25], # np.linspace(15, 50, 8, dtype = int),
