...
opt = LiveParams(
    ...
    fastMomentumMinutes = np.linspace(70, 125, 11, dtype = int),
    fastCrossoverPercent = [0], # [0, 75, 85, 95], # np.linspace(75, 95, 5),
    takeProfitPercent = np.around(np.linspace(0.5, 1.5, 11), 2),
    stopLossPercent = [0], # np.around(np.linspace(.25, .65, 9), 2),
    fastAngleEntryFactor = [25], # np.linspace(15, 35, 3, dtype = int),
    fastAngleExitFactor = [3015], # np.linspace(1000, 3000, 401, dtype = int),
    slowMinutes = [4555], # np.linspace(1755, 3055, 7, dtype = int),
    slowAngleFactor = [0, 5], # np.linspace(15, 50, 8, dtype = int),
    coolOffMinutes = [25], # np.linspace(0, 25, 26, dtype = int),
    trendStartHour = [15], # np.linspace(0, 12, 13, dtype = int),
