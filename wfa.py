...
opt = LiveParams(
    ...
    takeProfitPercent = np.around(np.linspace(0.25, 0.75, 11), 3),
    stopLossPercent = [0], # np.around(np.linspace(.25, .65, 9), 2),
    fastAngleEntryFactor = [20], # np.linspace(15, 35, 5, dtype = int),
    fastAngleExitFactor = [2125], # np.linspace(1000, 3000, 401, dtype = int),
