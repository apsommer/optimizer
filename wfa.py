...
opt = LiveParams(
    ...
    fastMomentumMinutes = [105], # np.linspace(95, 135, 9, dtype = int),
    fastCrossoverPercent = [0], # np.linspace(75, 95, 5),
    takeProfitPercent = [.35, .55], # np.around(np.linspace(.25, .65, 9), 2),
    stopLossPercent = [0] , # np.around(np.linspace(.45, .95, 11), 2),
    fastAngleEntryFactor = [15], # np.linspace(10, 50, 9, dtype = int),
